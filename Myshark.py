...
def start_capture(interface):
    ...
    capture_process = subprocess.Popen(["tshark", "-i", interface, "-w", "capture.pcap"])
    print(f"Capture started on interface {interface}! Press 'Ctrl+C' to stop and analyze.")

def stop_capture():
    capture_process.terminate()
    print("Capture stopped. Analyzing captured packets...")
